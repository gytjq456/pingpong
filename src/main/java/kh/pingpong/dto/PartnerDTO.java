...
public class PartnerDTO {
	...
	public PartnerDTO(int seq, String id, String name, int age, String gender, String email, String country,
			String phone_country, String phone, String address, String profile, String lang_can, String lang_learn,
			String hobby, String introduce, Timestamp partner_date, int review_count,
			int review_point) {
		super();
		this.seq = seq;
		this.id = id;
