...
public class tutorApp {
  ...
  public void testMessageInsert() {
     try {
        ...
        File targetFile = new File("D:\\서방.png");
        
        MockMultipartFile files = new MockMultipartFile("서방", targetFile.getName(), "text/plain", new FileInputStream(targetFile));
        
        System.out.println("============="+files.getBytes());
        mockMvc.perform(((MockMultipartHttpServletRequestBuilder) MockMvcRequestBuilders.multipart("/tutor/tutorAppSend").
              ...
              param("career","경력경력").
              param("exp","경험경험").
              param("introduce","소개소개").
              param("recomm","추천추천")
              ).andDo(MockMvcResultHandlers.print()).andExpect(MockMvcResultMatchers.status().isOk());
        logger.info("튜터 신청 성공");
     } catch (Exception e) {
